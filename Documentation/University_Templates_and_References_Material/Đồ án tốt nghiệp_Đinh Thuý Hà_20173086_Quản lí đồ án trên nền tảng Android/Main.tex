...
\subfile{Chuong/2_Khao_sat_va_phan_tich}
...
\subfile{Chuong/3_Cong_nghe_su_dung}

\newpage
%\pagestyle{fancy} % Áp dụng header và footer
\chapter{PHÁT TRIỂN VÀ TRIỂN KHAI ỨNG DỤNG}
\label{chapter:Experiment}
\subfile{Chuong/4_Phat_trien_va_trien_khai_ung_dung}
...
\subfile{Chuong/6_Ket_luan_huong_phat_trien}
